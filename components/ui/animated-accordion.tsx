...
export { Accordion as AnimatedAccordion, AccordionItem as AnimatedAccordionItem, AccordionTrigger as AnimatedAccordionTrigger, AccordionContent as AnimatedAccordionContent };
...
function AccordionContentPrimitive({
  ...
  return (
    <AnimatePresence>
      {keepRendered ? (
        <AccordionPrime.Content forceMount>
