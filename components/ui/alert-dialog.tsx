...
function AlertDialogOverlayPrimitive({
  ...
  return (
    <AlertDialogPrime.Overlay data-slot="alert-dialog-overlay" forceMount>
      <motion.div key="alert-dialog-overlay" initial={{ opacity: 0, filter: 'blur(4px)' }} animate={{ opacity: 1, filter: 'blur(0px)' }} exit={{ opacity: 0, filter: 'blur(4px)' }} transition={transition} {...props} />
